...
teaser: "Read my Hacker News #1 featured blog post on compiler basics"
date: 2017-13-08
status: "published"
---

import { Image } from "astro:assets";
import tweet from "../assets/blog/compilers/tweet.jpg";
import compiler1 from "../assets/blog/compilers/compiler1.jpg";
import lexer from "../assets/blog/compilers/lexer.jpg";
import tree from "../assets/blog/compilers/tree.jpg";

{/* ## <Image src={tweet} alt="A description of my image" width={400} /> */}
...
<img src={compiler1.src} alt="Compiler parts" />
...
- **The Lexer** (or scanner or tokenizer) converts a string of characters to a string of words. Each word, or token, is assigned to one of five syntactic categories: punctuation, keyword, identifier, literal, or comment.
  ...
  <Image src={lexer} alt="A description of my image" width={650} />
...
- **The Parser** determines whether or not the stream of words consists of valid sentences in the source language. After analyzing the grammar of the token stream, it outputs an abstract syntax tree (AST). Nodes in a Clang AST represent declarations, statements, and types.
  ...
  <Image src={tree} alt="A description of my image" width={650} />
